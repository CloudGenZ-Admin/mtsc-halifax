    ...
    <section className="grid grid-cols-1 md:grid-cols-2 min-h-[88vh] bg-coral-pale relative overflow-hidden">
      ...
      <div className="flex flex-col justify-center px-7 py-16 md:pl-16 md:pr-10 relative z-10">
        ...
        <div className="flex items-center gap-5 flex-wrap">
          <div className="flex flex-col"><strong className="text-2xl font-black text-coral">90%</strong><span className="text-xs font-semibold text-text-mid">World goods by sea</span></div>
          <div className="w-px h-9 bg-navy/20"></div>
          <div className="flex flex-col"><strong className="text-2xl font-black text-coral">7,104</strong><span className="text-xs font-semibold text-text-mid">Ships</span></div>
          <div className="w-px h-9 bg-navy/20"></div>
          <div className="flex flex-col"><strong className="text-2xl font-black text-coral">181K+</strong><span className="text-xs font-semibold text-text-mid">Seafarers</span></div>
          <div className="w-px h-9 bg-navy/20"></div>
          <div className="flex flex-col"><strong className="text-2xl font-black text-coral">160+</strong><span className="text-xs font-semibold text-text-mid">Year Legacy</span></div>
        </div>
      </div>
